...
class CustomDDIMScheduler(DDIMScheduler):
    def step(
        ...
        # print(f"model_output: {model_output.mean()}")
        # print(f"sample: {sample.mean()}")
        # print(f"prev_sample_mean: {prev_sample_mean.mean()}")
        # print(f"pred_original_sample: {pred_original_sample.mean()}")
        # print(f"alpha_prod_t_prev: {alpha_prod_t_prev.mean()}")
        # print(f"pred_sample_direction: {pred_sample_direction.mean()}")
        ...
        # print(f"prev_sample: {prev_sample.mean()}")
        # print(f"prev_sample_mean: {prev_sample_mean.mean()}")
        # print(f"std_dev_t: {std_dev_t.mean()}")
        log_prob = (
